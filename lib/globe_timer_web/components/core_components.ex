defmodule GlobeTimerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GlobeTimerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GlobeTimerWeb.Gettext, "errors", msg, opts)
    end
  end
